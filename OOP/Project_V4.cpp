...
#include "patientinfo.h"			//header		to include datamembers of class patientinfo
#include "Coded.h"					//header		to include datamembers of class Coded
#include "doc.h"					//header		to include datamembers of class add_doc
#include "Patient.h"				//header		to include Composition
